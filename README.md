...
**activity-box** is a [forked GitHub Action](https://github.com/JasonEtco/activity-box) that is designed to work using the [`schedule`](https://docs.github.com/en/actions/reference/events-that-trigger-workflows#schedule) event.
